...
title('GFPmut3-sRNA Response -- Annihilation Simple Mass Action', 'Interpreter','latex');
...
function dy = sRNA_ODEs(~, y, k, F, sRNA_trans, GFPmut3_trans, mu)
    ...
    dy(3) = F(2)*y(2) - mu * y(3);
    dy(4) = sRNA_t - (mu + F(3))*y(4) - 1*k(1)*y(1)*y(4);
end